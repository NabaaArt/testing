...
class TestNullValue008KtTest {
    ...
    fun should_ReturnCorrectAverage_When_HaveCorrectInput() {
        ...
        val average = findGrowthAverage1(age ,height)
    ...
    fun should_ReturnMinus1_When_AgeLargestThan18(){
        ...
        assertNull(average)
      //  assertNull() check if the actual value is null
     //   assertNotNull() check if the actual value is not null
